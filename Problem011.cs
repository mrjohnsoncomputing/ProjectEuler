...
namespace ProjectEuler
{
    class Problem011
    {
        ...
        public static int ColumnProduct(int row, int position)
        {
            int total = 1;
            for (int i = row; i < row + Seed; i++)
            {
                total *= GRID[i, position];
            }
            return total;
        }
        ...
        {
            int total = 1;
            for (int i = position; i < position + Seed; i++)
            {
                total *= GRID[row, i];
            }
            return total;
        ...
        public static int DiagonalProduct(int row, int position)
        {
            int total = 1;
